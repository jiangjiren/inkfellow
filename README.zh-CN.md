...
把你的 Markdown 笔记文件夹，变成一个可以在**任意设备、任意地点**通过浏览器**浏览、整理、同步、分享**的云端个人知识库——并内置 **AI Agent 对话面板**，划选任意文字即可引用进 AI 对话，让知识真正活起来。
...
传统笔记的使用方式是：**写 → 搜索 → 翻找 → 读**。时间一长，很多写过的内容就再也找不回来了。

**LLM Wiki** 把这个流程变成：**写 → 直接问 AI**。

你的每一篇笔记，都成为 AI 的"记忆"。你可以用自然语言向 AI 提问：
